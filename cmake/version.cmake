function(tianli_installer_parse_version file)
    file(STRINGS ${file} lines)
    foreach(line ${lines})
        string(REPLACE " " ";" parts ${line})
        list(GET parts 0 name)
        if(${name} STREQUAL "VersionOriginal")
    ...
    message("Version int: ${desktop_app_version_cmake}")

    set(tianli_installer_version_cmake ${version_dot} PARENT_SCOPE)
endfunction()